...
DECLARE
	...
	NumberRows bigint;
BEGIN
--Distributed Tables: Trips_distributed_by_2dGrid
	Mode = 'Cluster_trips_distributed_by_2dGrid';
	...
	loop
		...
		FROM Trips_distributed_by_2dGrid T, Stops_cluster S
	...
	loop
		...
		FROM Trips_distributed_by_2dGrid T, routes_cluster R
	...
	loop
		...
		FROM Trips_distributed_by_2dGrid T, Stops_cluster S, Routes_cluster R
	...
	loop
		...
		FROM Trips_distributed_by_2dGrid T, Routes_cluster R, agency_cluster A
	...
	loop
		...
		FROM Trips_distributed_by_2dGrid T, Routes_cluster R, agency_cluster A, Communes_cluster C
