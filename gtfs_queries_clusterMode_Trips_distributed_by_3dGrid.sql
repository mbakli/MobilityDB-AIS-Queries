...
DECLARE
	...
	NumberRows bigint;
BEGIN
--Distributed Tables: Trips_distributed_by_3dGrid
	Mode = 'Cluster_trips_distributed_by_3dGrid';
	...
	loop
		...
		FROM Trips_distributed_by_3dGrid T, Stops_cluster S
	...
	loop
		...
		FROM Trips_distributed_by_3dGrid T, routes_cluster R
	...
	loop
		...
		FROM Trips_distributed_by_3dGrid T, Stops_cluster S, Routes_cluster R
	...
	loop
		...
		FROM Trips_distributed_by_3dGrid T, Routes_cluster R, agency_cluster A
	...
	loop
		...
		FROM Trips_distributed_by_3dGrid T, Routes_cluster R, agency_cluster A, Communes_cluster C
