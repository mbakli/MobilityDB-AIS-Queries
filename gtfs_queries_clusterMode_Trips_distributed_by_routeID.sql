...
loop
	...
	FROM Trips_mdb_distributed_route_id T, Stops_cluster S, Routes_cluster R
...
loop
	...
	FROM Trips_mdb_distributed_route_id T, Routes_cluster R, agency_cluster A
...
loop
	...
	FROM Trips_mdb_distributed_route_id T, Routes_cluster R, agency_cluster A, Communes_cluster C
...
loop
	...
	FROM Trips_mdb_distributed_route_id T, Routes_cluster R
	WHERE T.route_id = R.route_id
